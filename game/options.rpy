...
define config.name = _("Project_Horror")
...
define build.name = "Project_Horror"
...
define config.main_menu_music = "bgm_clock.mp3"
...
define config.save_directory = "Project_Horror-1743762584"
