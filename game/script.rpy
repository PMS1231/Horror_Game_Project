    ...
    menu:
        ...
        "책장의 책을 살펴본다":
            if garret_info == False:
                ...
                n "지난번의 폭풍으로 창틀의 나무가 휘어진듯하니, "
                n "다음주 저택의 보수일정에 추가해야 할 듯합니다."
        ...
        "책장 위를 살펴본다":
            if diary_2 == False:
                ...
                "책장 위를 살펴보니 그곳엔 손때묻은 책이 1권 있었다."
                show 일기 at Transform(xalign=0.5, yalign=0.2) 
                m "이건 일기장인가?"

                n "집사의 일기장"
                n "최근 백작님은 도련님에게 많은 관심을 쏟고 계신다."
                n "최고급 옷과 장난감, 먹는음식까지"
                n "얼굴에는 웃음기가 지워지질 않으신다."
                n "그나저나 최근에는 업무가 많아서 아가씨를 뵙지 못하였다."
                n "아가씨를 마지막으로 본게 언제였더라..."
                n "걱정이 된다."
